...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        searchText: '',
        iconSize: undefined,
        buttonsClass: 'secondary isTooltip',
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showPaginationSwitch) {
            html.push(sprintf('<button class="btn' +
                ...
                '" type="button" name="paginationSwitch" aria-label="pagination Switch" title="%s">', //, this.options.tooltipPlacement  data-placement="%s"
        ...
        if (this.options.showColumns) {
            html.push('<div class="keep-open btn-group">',
                sprintf('<button type="button" aria-label="columns" title="%s" class="btn', this.options.formatColumns()) +
                sprintf(' btn-%s', this.options.buttonsClass) +
                sprintf(' btn-%s', this.options.iconSize) +
        ...
        if (this.options.search) {
            ...
            html.push(
                ...
                sprintf('<input class="form-control isTooltip' +
                    sprintf(' input-%s', this.options.iconSize) +
                    '" type="text" placeholder="%s" title="%s">',
                    this.options.formatSearch(), this.options.formatSearch()),
                '</div>');
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            $.each(pageList, function (i, page) {
                if (!that.options.smartDisplay || i === 0 || pageList[i - 1] < that.options.totalRows) {
                    ...
                    pageNumber.push(sprintf('<li role="menuitem"%s><a class="dropdown-item" href="javascript:;">%s</a></li>', active, page));
                }
            });
            ...
            html.push('</div>',
                ...
                '<li class="page-pre page-item"><a class="page-link" href="javascript;">' + this.options.paginationPreText + '</a></li>');
            ...
            if (this.totalPages >= 8) {
                if (this.options.pageNumber <= (this.totalPages - 4)) {
                    html.push('<li class="page-last-separator disabled">',
                        '<a class="page-link" class="page-item" href="javascript:;">...</a>',
                        '</li>');
                }
            }
            ...
            if (this.totalPages >= 6) {
                if (this.options.pageNumber <= (this.totalPages - 3)) {
                    html.push('<li class="page-last' + (this.totalPages === this.options.pageNumber ? ' active' : '') + '">',
                        '<a class="page-link" href="javascript:;">', this.totalPages, '</a>',
                        '</li>');
                }
            }

            html.push(
                '<li class="page-next page-item"><a class="page-link" href="javascript:;">' + this.options.paginationNextText + '</a></li>',
                '</ul>',
                '</div>');
        }
